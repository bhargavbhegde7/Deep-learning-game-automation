...
def create_training_samples():
	#for imgName in range(1, 130):
	path = os.path.join(DATADIR)
	
	IMG_SIZE = 100
	for img in tqdm(range(0, TRAINING_AMOUNT+1)):
		try:
			img_array = cv2.imread(os.path.join(path,str(img)+".jpg") ,cv2.IMREAD_GRAYSCALE)
...
print("training_data_samples : ",len(training_data_samples))
print("training_data_labels : ",len(training_data_labels))

print("test_data_samples : ",len(test_data_samples))
